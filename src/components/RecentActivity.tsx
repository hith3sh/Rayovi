    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {activities.map((activity) => (
          <div key={activity.id} className="card-letterboxd p-4 transition-all duration-200 hover:border-primary/30">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-shrink-0">
                <img 
                  ...
                  className="h-12 w-20 rounded object-cover transition-transform duration-200 hover:scale-105"
                />
              </div>
            </div>
          </div>
