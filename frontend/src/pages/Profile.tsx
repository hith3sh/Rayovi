              ...
              <div className="container mx-auto px-4 py-8">
                          ...
                          {recentLikes.map((video) => (
                            <div key={video.id} className="group">
                              <Link to={`/video/${video.id}`}>
                                <div className="aspect-[2/3] overflow-hidden rounded-md bg-muted transition-transform duration-300">
                                  <img 
                                    src={video.thumbnail} 
                                    alt={video.title}
                ...
                <TabsContent value="lists" className="space-y-6 mt-0">
                  ...
                  <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {videoLists.map((list) => (
                      <Card key={list.id} className="card-letterboxd material-hover">
